...
public class ModuleController {
	...
	public ResponseEntity<Object> updateModule(@Valid @RequestBody ModuleDto moduleDto) {
		...
		return new ResponseEntity<>(new ValidationFailureResponse(ValidationConstance.MODULE_EXISTS,validationFailureStatusCodes.getExistsById()),HttpStatus.BAD_REQUEST);
	}
