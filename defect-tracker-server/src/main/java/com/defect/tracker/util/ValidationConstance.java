...
public class ValidationConstance {
	...
	public static final String MODULE_NOT_RELATION_PROJECT_ID = " Module_id not relation in Project_id";
	public static final String SUB_MODULE_NOT_RELATION_MODULE_ID = " SubmModule_id not relation Module_id";
	...
	public static final String MODULE_EXISTS_BY_PROJECT_ID = "Module Id not Exists By Project Id";
