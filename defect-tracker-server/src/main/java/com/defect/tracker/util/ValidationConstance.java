...
public class ValidationConstance {
	...
	public static final String DESIGNATION_DELETE_EXISTS_BY_ID = "Designation is not Exists";
	public static final String DESIGNATION_NOT_EXISTS_BY_ID = "Designation is not Exis";
